...
const fadeDelay = 15; // delay before next element can fade
const fadeDistance = 1.15; // distance the element needs to be on screen to fade (window.innerHeight / revealDistance)
